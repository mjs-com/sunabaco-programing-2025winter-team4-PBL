...
export const DiaryDetailModal = React.memo(function DiaryDetailModal({
  diary,
  currentUserId,
  isAdmin = false,
  categories,
  ...
  const [loadedJobTypes, setLoadedJobTypes] =
    useState<JobType[]>(jobTypes);
    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b p-4">
          <h2 className="text-lg font-bold">日報詳細</h2>
          <Button variant="ghost" size="icon" onClick={onClose}>
            <X />
          </Button>
        </div>
        ...
        <div className="p-4 space-y-4">
          {isEditing ? (
            ...
            <>
              ...
              <CategoryBadge
                categoryName={diary.category?.category_name || ''}
              />
